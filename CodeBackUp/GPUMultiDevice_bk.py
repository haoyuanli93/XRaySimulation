...
def get_multicrystal_reflection(kin_grid,
    ...
    :param batch_num: When the array is larger than the GPU memory, divide the array into several batches.
    :return:
    """

    if batch_num == 1:
        _get_multicrystal_reflection(kin_grid = kin_grid,
...
def getElectricFieldPerCavityCircle(dx, dy, dz,
    ...
    # Get meta data
    kin_grid = np.zeros_like(spectrum_in)
    k_num = kin_grid.shape[0]
